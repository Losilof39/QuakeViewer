...
//#include <matrix.hpp>
//
//// link to header: https://gist.github.com/podgorskiy/e698d18879588ada9014768e3e82a644
//
//class Frustum
//{
//public:
//
//	static Frustum* GetInstance(void);
//
//	// m = ProjectionMatrix * ViewMatrix 
//	void GetMVP(glm::mat4 m);
//
...
//};
//
//inline Frustum* Frustum::GetInstance(void)
//{
//	static Frustum instance;
//	return &instance;
//}
//
//void inline Frustum::ExtractPlanes(void)
//{
//	m_MVP = glm::transpose(m_MVP);
//	m_planes[Left] = m_MVP[3] + m_MVP[0];
//	m_planes[Right] = m_MVP[3] - m_MVP[0];
//	m_planes[Bottom] = m_MVP[3] + m_MVP[1];
//	m_planes[Top] = m_MVP[3] - m_MVP[1];
//	m_planes[Near] = m_MVP[3] + m_MVP[2];
//	m_planes[Far] = m_MVP[3] - m_MVP[2];
//
...
//}
//
//void inline Frustum::GetMVP(glm::mat4 m)
//{
//	m_MVP = m;
//	ExtractPlanes();
//}
...
//	}
//
//	// i dont know why this is here but whatever
//
